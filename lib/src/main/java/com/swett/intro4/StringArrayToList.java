...
public class StringArrayToList {
     ...
     * It calls the converter function using my instance variables and prints result
     * types
     */
    public void go() {
        ...
        // I used a lambda to print each element of my list, something tells me there's
        // a better way
        myList.forEach((e) -> {
    ...
    /**
     * The entry point into my program. It calls my program object and tells it to
     * go.
